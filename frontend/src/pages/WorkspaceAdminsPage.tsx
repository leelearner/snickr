    ...
    <MainContent>
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">Admins across the workspaces you belong to.</p>
        </div>
      </div>
            ...
            <section className="rounded-lg border border-slate-200 bg-white">
              ...
              <div className="divide-y divide-slate-100">
                {group.admins.map((admin) => (
                  <div
                    key={`${admin.workspaceId}-${admin.userId}`}
                    className="flex items-center gap-3 px-4 py-2.5"
                  >
                    <Avatar
                      name={safeDisplayName(admin.nickname, admin.username)}
                      className="h-8 w-8"
                    />
